...
const AllJobApplicants = (props) => {
    const {allJobApplicants} = useContext(AuthContext)
    ...
    const HandleResumeDownload = (row) => {
        return (
            <>
                <a href={row.original.resumeUrl}>Download</a>
            </>
        )
    }
            ...
            <>
                ...
                <Popover placement="bottom" ref={buttonRef}>
                    <PopoverContainer>
                        <PopoverBody>
                            <>
                                <p><button onClick={() => {createUser(row)}}>Onboard</button></p>
                            </>
                        </PopoverBody>
                    </PopoverContainer>
                </Popover>
    ...
    const columns = useMemo(
        () => [
...

            {
                Header: 'Resume',
                accessor: 'resumeUrl',
                Cell: ({row}) => HandleResumeDownload(row),
            },
    ...
    const data = useMemo(() => allJobApplicants, []);
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
        ...
        <Fragment>
            ...
            { createUserModal &&
                <Modal onClose={closeModal}>
                    <CreateUser userData={userData} closeModal={closeModal}/>
                </Modal>}
